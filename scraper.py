...
#usa parslepy per individuare i dati da screpare sulla pagina degli annunci https://www.immobiliare.it/vendita-case/milano/?criterio=rilevanza
...
next_url = "https://www.immobiliare.it/vendita-case/milano/?criterio=rilevanza"
...
while next_url:
    ...
    for release in extracted.get("annunci"):
        ...
        dethtml = requests.get("http://www.immobiliare.it/"+release['annuncio_url'])
       ...
       #non ditemi niente. Non ho trovato una soluzione migliore per ottenere la data! :-)
        ...
        data = {
            'giorno' : gg,
            'url' : "http://www.immobiliare.it/"+release['annuncio_url'],
